...
def main():
    while True:
        ...
        if choice == 'a':
            ...
            def dictionary_attack(target_password):
                for word in dictionary:
                    if word == target_password:
                        return word  # Le mot de passe a été trouvé dans le dictionnaire
                return None  # Le mot de passe n'a pas été trouvé dans le dictionnaire
            ...
            x=dictionnaire()
            print(x)
            #print("Cette option n'est pas implémentée.")
        elif choice == 'd':
            break
        else:
