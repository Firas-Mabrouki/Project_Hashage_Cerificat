...
def valider_adresse_email(email):
    return re.match(r"[^@]+@[^@]+\.[^@]+", email)

while True:
    email = input("Entrez votre adresse e-mail : ")
    if not valider_adresse_email(email):
...
def lire_informations_utilisateurs():
...
def authentification():
    ...
    informations_utilisateurs = lire_informations_utilisateurs()
